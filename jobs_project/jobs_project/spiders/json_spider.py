...
class Jobpider(scrapy.Spider):
    ...
    def start_requests(self):
        """
            Starting two different Scrapy Request for both Json files
        """
    ...
    def parse_page(self, response):
        ...
        for job in response_json["jobs"]:
            # Creating new JobsItem in every iteration and getting its 'data' column
            job_item = JobsItem()
            job_data = job["data"]
            ...
            # Categories are array of jsonb. So a lambda function called for every dictionary item in categories.
            ...
            # Date objects created with given format from Date strings
